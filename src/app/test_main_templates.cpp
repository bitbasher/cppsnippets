...
int main(int argc, char *argv[]) {
    ...
    QWidget window;
    window.setWindowTitle("TEST: Templates Tab Only");
    ...
    qDebug() << "Step 4: Creating dummy container for templates tab...";
    QTabWidget* testTabs = new QTabWidget(&window);
    qDebug() << "✓ Test container created\n";
    
    qDebug() << "Step 5: Calling setupTemplatesTab()...\n";
    try {
