...
| FontsLocation | 2 | "/System/Library/Fonts" (RO) | "C:/Windows/Fonts" (RO) | "~/.fonts": "~/.local/share/fonts": "/usr/local/share/fonts": "/usr/share/fonts" | fonts |
...
| TempLocation | 7 | randomly generated by the OS | "C:/Users&lt;USER&gt;/AppData/Local/Temp" | "/tmp" | temp folder |
...
| GenericDataLocation | 11 | "~/Library/Application Support", "/Library/Application Support" | "C:/Users/&lt;USER&gt;/AppData/Local"; "C:/ProgramData", "&lt;APPDIR&gt;"; "&lt;APPDIR&gt;/data" | "~/.local/share","/usr/local/share","/usr/share" | directory location where persistent data shared across applications can be stored. This is a generic value. The returned path is never empty. |
| ConfigLocation | 13 | "~/Library/Preferences", "&lt;APPDIR&gt;" | "C:/Users/&lt;USER&gt; /AppData/Local/&lt;APPNAME&gt;"; "C:/ProgramData/&lt;APPNAME&gt;", "&lt;APPDIR&gt;", "&lt;APPDIR&gt;" | "~/.config": "/etc/xdg" | directory location where user-specific configuration files should be written. This may be either a generic value or application-specific, and the returned path is never empty. |
| DownloadLocation | 14 | "~/Downloads" | "C:/Users/&lt;USER&gt;/Downloads" | "~/Downloads" | download folder |
| AppDataLocation | 17 | "~/Library/Application Support/&lt;APPNAME&gt;": "/Library/Application Support/&lt;APPNAME&gt;". "&lt;APPDIR&gt;/../Resources" | "C:/Users/&lt;USER&gt;/AppData/Roaming/&lt;APPNAME&gt;"; "C:/ProgramData/&lt;APPNAME&gt;"; "&lt;APPDIR&gt;", "&lt;APPDIR&gt;/data", "&lt;APPDIR&gt;/data/&lt;APPNAME&gt;" | "~/.local/share/&lt;APPNAME&gt;": "/usr/local/share/&lt;APPNAME&gt;": "/usr/share/&lt;APPNAME&gt;" | directory location where persistent application data can be stored. This is an application-specific directory. The returned path is never empty. On the Windows operating system, this returns the roaming path. |
| AppConfigLocation | 18 | "~/Library/Preferences/&lt;APPNAME&gt;", "&lt;APPDIR&gt;" | "C:/Users/&lt;USER&gt;/AppData/Local/&lt;APPNAME&gt;"; "C:/ProgramData/&lt;APPNAME&gt;", "&lt;APPDIR&gt;" | "~/.config/&lt;APPNAME&gt;": "/etc/xdg/&lt;APPNAME&gt;", "&lt;APPDIR&gt;" | directory location where user-specific configuration files should be written. This is an application-specific directory, and the returned path is never empty |
| PublicShareLocation | 19 | "~/Public" | "C:/Users/Public" | "~/Public" | directory location where user-specific publicly shared files and directories can be stored. This is a generic value. Note that the returned path may be empty if the system has no concept of a publicly shared location |
| TemplatesLocation | 20 | "~/Templates" | "C:/Users/&lt;USER&gt;/AppData/Roaming/Microsoft/Windows/Templates" | "~/Templates" | directory location where user-specific template files can be stored. This is a generic value. Note that the returned path may be empty if the system has no concept of a templates location |
