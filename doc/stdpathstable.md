...
where a path has (R-O) appended, short for Read-Only, it means that that location cannnot be written to.
...
- **`<USER>`** - Replaced with the username
  - Example: `C:/Users/<USER>/Desktop` → `C:/Users/aUser/Desktop`
  
- **`<APPNAME>`** - Replaced with organization and application name as **two-level directory structure**
  - Example: `C:/Users/<USER>/AppData/Local/<APPNAME>` → `C:/Users/aUser/AppData/Local/companyName/appName`
  - Format: `<ORGNAME>/<APPNAME>` (two directory levels, not a single, combined string)
...
- **`<APPDIR>`** - Replaced with the executable's directory. Used to provide a fallback location for paths that may not be empty
  - Example: `<APPDIR>/data` → `C:\Program Files\appName\`
...
int main(int argc, char *argv[])
{
    ...
    app.setOrganizationName("companyName"); // use no whitespace
    
    // Set application name (second directory level)
    app.setApplicationName("appName");  // use no whitespace
    
    // QStandardPaths will now use these values for <APPNAME> expansion
    // Result: paths like "C:/Users/auser/AppData/Local/companyName/appName"
...
Thus we find that Config locations include `<APPDIR>` as a fallback which is not documented in [QStandardPaths](https://doc.qt.io/qt-6/qstandardpaths.html#details).

See [QtExploration/README.md](../QtExploration/README.md) for the test results showing expected vs actual tag expansion.
...
| AppLocalDataLocation | 9 | AS | App | | "~/Library/Application Support/&lt;ORGNAME&gt;/&lt;APPNAME&gt;", "/Library/Application Support/&lt;ORGNAME&gt;/&lt;APPNAME&gt;". "&lt;APPDIR&gt;/../Resources" | "C:/Users/&lt;USER&gt;/AppData/Local/&lt;ORGNAME&gt;/&lt;APPNAME&gt;", "C:/ProgramData/&lt;ORGNAME&gt;/&lt;APPNAME&gt;", "&lt;APPDIR&gt;", "&lt;APPDIR&gt;/data", "&lt;APPDIR&gt;/data/&lt;ORGNAME&gt;/&lt;APPNAME&gt;" | "~/.local/share/&lt;ORGNAME&gt;/&lt;APPNAME&gt;", "/usr/local/share/&lt;ORGNAME&gt;/&lt;APPNAME&gt;", "/usr/share/&lt;ORGNAME&gt;/&lt;APPNAME&gt;" | 5.4 | Local settings path on Windows. On other platforms, same as AppDataLocation. |
| CacheLocation | 10 | AS | App | NE | "~/Library/Caches/&lt;ORGNAME&gt;/&lt;APPNAME&gt;", "/Library/Caches/&lt;ORGNAME&gt;/&lt;APPNAME&gt;" | "C:/Users/&lt;USER&gt;/AppData/Local/&lt;ORGNAME&gt;/&lt;APPNAME&gt;/cache" | "~/.cache/&lt;ORGNAME&gt;/&lt;APPNAME&gt;" | | Application-specific directory for non-essential cached data. |
...
| ConfigLocation | 13 | Mixed | App | NE | "~/Library/Preferences" | "C:/Users/&lt;USER&gt;/AppData/Local/&lt;ORGNAME&gt;/&lt;APPNAME&gt;", "C:/ProgramData/&lt;ORGNAME&gt;/&lt;APPNAME&gt;" | "~/.config", "/etc/xdg" | | Directory for user-specific configuration files. May be generic or app-specific. |
...
| AppDataLocation | 17 | AS | App | NE | "~/Library/Application Support/&lt;ORGNAME&gt;/&lt;APPNAME&gt;", "/Library/Application Support/&lt;ORGNAME&gt;/&lt;APPNAME&gt;". "&lt;APPDIR&gt;/../Resources" | "C:/Users/&lt;USER&gt;/AppData/Roaming/&lt;ORGNAME&gt;/&lt;APPNAME&gt;", "C:/ProgramData/&lt;ORGNAME&gt;/&lt;APPNAME&gt;", "&lt;APPDIR&gt;", "&lt;APPDIR&gt;/data", "&lt;APPDIR&gt;/data/&lt;ORGNAME&gt;/&lt;APPNAME&gt;" | "~/.local/share/&lt;ORGNAME&gt;/&lt;APPNAME&gt;", "/usr/local/share/&lt;ORGNAME&gt;/&lt;APPNAME&gt;", "/usr/share/&lt;ORGNAME&gt;/&lt;APPNAME&gt;" | 5.4 | Application-specific directory for persistent data. On Windows, returns roaming path. Use GenericDataLocation for shared data. |
| AppConfigLocation | 18 | AS | App | NE | "~/Library/Preferences/&lt;ORGNAME&gt;/&lt;APPNAME&gt;" | "C:/Users/&lt;USER&gt;/AppData/Local/&lt;ORGNAME&gt;/&lt;APPNAME&gt;", "C:/ProgramData/&lt;ORGNAME&gt;/&lt;APPNAME&gt;" | "~/.config/&lt;ORGNAME&gt;/&lt;APPNAME&gt;", "/etc/xdg/&lt;ORGNAME&gt;/&lt;APPNAME&gt;" | 5.5 | Application-specific directory for configuration files. |
...
| StateLocation | 21 | AS | App | NE | "~/Library/Preferences/&lt;ORGNAME&gt;/&lt;APPNAME&gt;/State" | "C:/Users/&lt;USER&gt;/AppData/Local/&lt;ORGNAME&gt;/&lt;APPNAME&gt;/State", "C:/ProgramData/&lt;ORGNAME&gt;/&lt;APPNAME&gt;/State" | "~/.local/state/&lt;ORGNAME&gt;/&lt;APPNAME&gt;" | 6.7 | Application-specific directory for state data files. |
| GenericStateLocation | 22 | Mixed | Sys | NE | "~/Library/Preferences/State" | "C:/Users/&lt;USER&gt;/AppData/Local/State", "C:/ProgramData/&lt;ORGNAME&gt;/&lt;APPNAME&gt;/State" | "~/.local/state" | 6.7 | Directory for shared state data files across applications. May be generic or app-specific. |
